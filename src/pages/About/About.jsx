...
const About = () => {
    return (
        <>
            ...
            <h1 className="pt-8 text-center text-3xl lg:text-6xl font-bold bg-gradient-to-r from-blue-400 via-purple-500 to-pink-500 text-transparent bg-clip-text">About me!</h1>
            <div className="bg-white inner-container py-8 space-y-4 flex items-center justify-between">
                <div className="text-xl text-bandSecondary space-y-3 w-1/2">
                    <p>Name: <span className="font-bold">MD. Nazmus Sakib Sheam</span></p>
                    ...
                    <button className="w-56 block py-2 px-5 rounded-full text-white bg-bandPrimary hover:bg-bandSecondary font-bold">Download Resume</button>
                    <button className="w-56 block py-2 px-5 rounded-full text-white bg-bandPrimary hover:bg-bandSecondary font-bold">Download CV</button>
                    
                </div>
                <div className="bg-bandSecondary text-white p-6 rounded-lg w-1/2">
                    <p>Hello! Myself <span className="font-bold text-green-500">MD. Nazmus Sakib Sheam</span> I am a <span  className="font-bold text-green-500">MERN Stack Developer</span>. As a MERN stack developer, I have a good understanding of HTML, CSS, and JavaScript, and I have successfully worked on over 30 projects. With my expertise in these core technologies, I specialize in building dynamic and responsive web applications.
