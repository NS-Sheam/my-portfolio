    ...
    return (
        <section className='bg-gradient-to-tr from-bandPrimary to-bandSecondary inner-container lg:min-h-screen p-4 lg:p-6'>
            <div
                ...
                data-aos-offset="100"
                className={`w-full lg:w-4/5 mx-auto text-center p-4 lg:p-8 -mt-16 lg:-mt-20 bg-bandTernary rounded-2xl space-y-4 lg:space-y-6`}>
