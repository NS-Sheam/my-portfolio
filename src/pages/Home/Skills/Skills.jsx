    ...
    return (
        <section className='bg-gradient-to-tr from-bandPrimary to-bandSecondary inner-container lg:min-h-screen p-4 lg:p-6'>
            <div
                ...
                data-aos-offset="100"
                className={`w-full lg:w-4/5 mx-auto text-center p-4 lg:p-8 -mt-16 lg:-mt-20 bg-bandTernary rounded-2xl`}>
                <h1 className='text-white text-xl lg:text-5xl italic font-bold mb-4'>Skills</h1>
