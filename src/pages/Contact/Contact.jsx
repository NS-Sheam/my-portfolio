            ...
            <div
                ...
                <div className="hero-content flex-col lg:flex-row justify-between gap-16 lg:w-4/5">
                    ...
                    className="bg-transparent w-full lg:w-1/2">
                        <form
                            ref={form} onSubmit={sendEmail} className="space-y-4 lg:space-y-6">
                            ...
                            data-aos-anchor="#example-anchor"
                            data-aos-duration="1000"
                            placeholder="email body" name="message" className={`p-3 text-base textarea textarea-bordered textarea-lg w-full ${theme == "light" ? "bg-slate-800 shadow-slate-800" : "bg-white"}`} ></textarea>
                            <div
                            data-aos="fade-up"
                            data-aos-anchor="#example-anchor"
                            data-aos-duration="1000"
