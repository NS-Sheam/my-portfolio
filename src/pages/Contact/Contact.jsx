...
const Contact = () => {
    ...
    return (
        <>
            ...
            <div className="hero min-h-screen w-full lg:py-6">
                <div className="hero-content flex-col lg:flex-row justify-between gap-16 lg:w-4/5">
                    <div className="bg-transparent w-full lg:w-1/2">
                        <form ref={form} onSubmit={sendEmail} className="space-y-4 lg:space-y-6">
                            <h1 className="text-center text-3xl lg:text-6xl font-bold bg-gradient-to-r from-blue-400 via-purple-500 to-pink-500 text-transparent bg-clip-text">Contact me!</h1>
                            ...
                            <textarea placeholder="email body" name="message" className={`p-3 text-base textarea textarea-bordered textarea-lg w-full ${theme == "light" ? "bg-slate-800 shadow-slate-800" : "bg-white"}`} ></textarea>
                            <div className="form-control mt-6">
                                <button className="btn bg-bandSecondary text-white hover:bg-opacity-25">Send</button>
                            </div>
                        </form>
                    </div>
